...
(function ($) {
    ...
    $.fn.slider = function (_c19, _c1a) {
        ...
        return this.each(function () {
            ...
            if (_c1b) {
                ...
                _c1b = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _c19),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_c1f) {
        var t = $(_c1f);
        return $.extend({}, $.parser.parseOptions(_c1f, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_c20) {
            return _c20;
        },
        converter: {
            toPosition: function (_c21, size) {
                var opts = $(this).slider("options");
